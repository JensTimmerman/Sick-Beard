...
from sickbeard import download_station
...
def _downloadResult(result):
    ...
    # if it's an nzb data result
        ...
        try:
            ...
            logger.log(u"Error trying to save NZB to black hole: " +
                       ex(e), logger.ERROR)
            newResult = False
...
def snatchEpisode(result, endStatus=SNATCHED):
    ...
    if result.resultType in ("nzb", "nzbdata"):
        if sickbeard.NZB_METHOD == "blackhole":
            ...
            logger.log(u"Unknown NZB action specified in config: " +
    ...
    # TORRENTs can be sent to Clients or saved to disk
        ...
        # torrents are sended to torrent client
            ...
            dlResult = download_station.sendTORRENT(result)
    else:
...
def searchForNeededEpisodes():
    ...
    for curProvider in providers.sortedProviderList():
        ...
        try:
            ...
            logger.log(u"Error while searching " + curProvider.name +
...
def pickBestResult(results, quality_list=None):
    ...
    logger.log(u"Picking the best result out of " + str([
               x.name for x in results]), logger.DEBUG)
...
def isFinalResult(result):
    ...
    logger.log(u"Checking if we should keep searching after we've found " +
...
def findSeason(show, season):
    ...
    if SEASON_RESULT in foundResults:
        bestSeasonNZB = pickBestResult(
            foundResults[SEASON_RESULT], anyQualities + bestQualities)
    ...
    logger.log(u"The highest quality of any match is " +
